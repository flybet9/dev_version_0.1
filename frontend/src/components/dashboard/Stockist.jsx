  ...
  return (
    <Fragment>
      <div className='sst-content'>
        <h2>Stockist Content</h2>  
        <button onClick={toggleView} className='add-sst-button'>
          {showTable ? 'Add Admin' : 'Back to Table'}
        </button><br />
        {showTable ? (
          ...
          <div className='form-container'>
            <form>
              ...
              <div className='form-row'>
                ...
                <div className='form-group'>
                  <label htmlFor='sstMatchShare'>Stockist Match Share:</label>
              ...
              <div className='form-row'>
                <div className='form-group'>
                  <label htmlFor='sstMatchCommission'>Stockist Match Commission:</label>
                  <input type='text' id='sstMatchCommission' name='sstMatchCommission' />
                </div>

                <div className='form-group'>
                  <label htmlFor='sstSessionCommission'>Stockist Session Commission:</label>
