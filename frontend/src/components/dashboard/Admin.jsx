          ...
          <div className='form-container'>
            <form>
              ...
              <div className='form-row'>
                ...
                <div className='form-group'>
                  <label htmlFor='sstMatchShare'>Admin Match Share:</label>
              ...
              <div className='form-row'>
                <div className='form-group'>
                  <label htmlFor='sstMatchCommission'>Admin Match Commission:</label>
                  <input type='text' id='sstMatchCommission' name='sstMatchCommission' />
                </div>

                <div className='form-group'>
                  <label htmlFor='sstSessionCommission'>Admin Session Commission:</label>
