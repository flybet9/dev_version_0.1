    ...
    <Fragment>
      <div className='sst-content'>
        ...
        <button onClick={toggleView} className='add-sst-button'>
          {showTable ? 'Add Agent' : 'Back to Table'}
        </button><br />
        {showTable ? (
          ...
          <div className='form-container'>
            <form>
              ...
              <div className='form-row'>
                ...
                <div className='form-group'>
                  <label htmlFor='sstMatchShare'>Agent Match Share:</label>
              ...
              <div className='form-row'>
                <div className='form-group'>
                  <label htmlFor='sstMatchCommission'>Agent Match Commission:</label>
                  <input type='text' id='sstMatchCommission' name='sstMatchCommission' />
                </div>

                <div className='form-group'>
                  <label htmlFor='sstSessionCommission'>Agent Session Commission:</label>
