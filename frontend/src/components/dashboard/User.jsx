    ...
    <Fragment>
      <div className='sst-content'>
        ...
        <button onClick={toggleView} className='add-sst-button'>
          {showTable ? 'Add User' : 'Back to Table'}
        </button><br />
        {showTable ? (
          ...
          <div className='form-container'>
            <form>
              ...
              <div className='form-row'>
                ...
                <div className='form-group'>
                  <label htmlFor='sstMatchShare'>User Match Share:</label>
              ...
              <div className='form-row'>
                <div className='form-group'>
                  <label htmlFor='sstMatchCommission'>User Match Commission:</label>
                  <input type='text' id='sstMatchCommission' name='sstMatchCommission' />
                </div>

                <div className='form-group'>
                  <label htmlFor='sstSessionCommission'>User Session Commission:</label>
